 ...
 *
 * В проекте это проверяется числом: «активность держится не меньше 300 мс
 * после снятия стимула». 300 мс — не произвол: это характерное время
 * удержания в задачах отсроченного ответа у приматов.
 *
 * ─── Ритмы ───────────────────────────────────────────────────────────────
 *
